  ...
  return (
    <div className="">
      <main className="max-w-4xl mx-auto p-6 font-mono">
        <h2 className="text-xl font-bold tracking-[0.25em] glow-cyan text-center">BACKTEST LAB</h2>
        ...
        {opt && (
          <div className="hud-panel hud-panel-static p-3 mb-4" style={{ borderColor: opt.shipped ? "rgba(52,211,153,0.4)" : "rgba(76,201,255,0.35)" }}>
